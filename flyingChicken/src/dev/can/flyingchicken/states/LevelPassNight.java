...
public class LevelPassNight extends State {
    private BufferedImage night;
    private EntityManager entityManager;
    private double timer = 0;

    public LevelPassNight(Game game) {
        super(game);
    ...
    public void render(Graphics g) {
        ...
        g.drawImage(Assets.label_level[2], game.getWidth()/2 - 120, game.getHeight()/2 - 120, 240, 240, null);
        g.drawImage(Assets.level_rule[2], game.getWidth()/2 - 150, game.getHeight()/2 + 30, 300, 75, null);
    }
}
